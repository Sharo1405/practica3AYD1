<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="diagrama.aspx.cs" Inherits="diagrama.diagrama.diagrama" %>
...
<body>
    ...
    <script>
     ...
     var diagramUrl = 'diagrama/diagrama_ini.txt';
   ...
   //  window.open('app3/diagram1.txt');
    ...
    //  $('#save-button').click(exportDiagram);
                		...
                		<div class="container-login100-form-btn">
                           ...
                           <asp:button id="aceptar" runat="server"   CssClass="btn btn-success"  OnClientClick="exportDiagram();" Text="Agregar " OnClick="aceptar_Click1"/>
