<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="consulta3.aspx.cs" Inherits="diagrama.app.consulta3" %>
		...
		<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
			<div class="wrap-login100 p-l-25 p-r-25 p-t-25 p-b-24">
					...
					<span class="login100-form-title p-b-49">
						Consulta 3<br />
                    Pausa</span><div class="wrap-input100 text-center">
                 ...
                 <div class="wrap-input100 text-center">
					    ...
					    <br />
                           <asp:button id="consulta" runat="server"   CssClass="btn btn-success"   Text="Realizar Consulta" OnClick="consulta_Click" />
